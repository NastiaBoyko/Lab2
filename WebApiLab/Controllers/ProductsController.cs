...
namespace WebApiLab.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        {
            var product = await _context.Product.Include(c => c.Category)
        ...
        {
            var cat = _context.Category.FirstOrDefault(c => c.Name == product.Category.Name);
            if (cat == null)
            {
                cat = new Category { Name = product.Category.Name };
